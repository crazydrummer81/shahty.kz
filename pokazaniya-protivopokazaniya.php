<?php
    require("module.php");
    $page_title = file_get_contents("text/pokazaniya-protivopokazaniya/title.html");
    $page_description = file_get_contents("text/pokazaniya-protivopokazaniya/description.html");
    $h1 = file_get_contents("text/pokazaniya-protivopokazaniya/heading.html");
    $text = file_get_contents("text/pokazaniya-protivopokazaniya/content.html");
?>
...
<?php
    ...
    $section_filename = file_get_contents("text/pokazaniya-protivopokazaniya/content.html");
