<?php
    require("module.php");
    $page_title = file_get_contents("text/kontakty/title.html");
    $page_description = file_get_contents("text/kontakty/description.html");
    $h1 = file_get_contents("text/kontakty/heading.html");
